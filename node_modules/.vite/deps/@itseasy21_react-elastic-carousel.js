...
// node_modules/@itseasy21/react-elastic-carousel/dist/index.es.js
...
function getHandlers(set, handlerProps) {
  ...
  const attachTouch = (el, props) => {
    ...
    if (el && el.addEventListener) {
      ...
      tls.forEach(([e2, h, o2]) => el.addEventListener(e2, h, o2));
      cleanup = () => tls.forEach(([e2, h]) => el.removeEventListener(e2, h));
    }
    return cleanup;
  };
  const onRef = (el) => {
...
// node_modules/@uiw/react-only-when/esm/index.js
var import_react2 = __toESM(require_react());

// node_modules/@uiw/react-only-when/esm/If.js
var If = (props) => props.condition ? props.render ? props.render() : props.children : null;
...
function OnlyWhen(props) {
  ...
  var _singleChild$props = singleChild.props, {
    style
  } = _singleChild$props, restOfChildProps = _objectWithoutPropertiesLoose(_singleChild$props, _excluded);
  ...
  var toHide = (0, import_jsx_runtime.jsx)(If, {
    condition: keepNode,
    children: cloned
  });
...
ItemWrapper.propTypes = {
  ...
  itemPosition: import_prop_types.default.oneOf([consts.START, consts.CENTER, consts.END])
};
...
var ItemWrapperContainer = function(_React$Component) {
  ...
  _createClass(ItemWrapperContainer2, [{
    ...
    value: function render() {
      return import_react3.default.createElement(ItemWrapper, _extends2({}, this.props, {
...
var Track = function Track2(_ref) {
  ...
  var toRender = enableSwipe ? import_react3.default.createElement("div", _extends2({
    style: {
      display: "flex",
...
Track.propTypes = {
  ...
  itemsToShow: import_prop_types.default.number.isRequired,
  noAutoTabbedItems: import_prop_types.default.bool,
  currentItem: import_prop_types.default.number.isRequired,
  itemPosition: import_prop_types.default.string,
  itemPadding: import_prop_types.default.array,
  childWidth: import_prop_types.default.number,
  verticalMode: import_prop_types.default.bool,
  enableSwipe: import_prop_types.default.bool,
  enableMouseSwipe: import_prop_types.default.bool,
...
var Arrow = function Arrow2(_ref) {
  ...
  return import_react3.default.createElement(Button, _extends2({
    tabIndex: 0,
    onClick,
...
Arrow.down = "down";
Arrow.propTypes = {
  direction: import_prop_types.default.oneOf(["left", "right", "up", "down"]).isRequired,
...
Pagination.propTypes = {
  numOfPages: import_prop_types.default.number.isRequired,
...
var Carousel = function(_React$Component) {
  ...
  _createClass(Carousel2, [{
    ...
    value: function render() {
      ...
      }, import_react3.default.createElement(OnlyWhen, {
        when: showArrows
...
Carousel.propTypes = {
  ...
  /** Animation speed */
  transitionMs: import_prop_types.default.number,
  /** transition easing pattern */
  easing: import_prop_types.default.string,
  /** transition easing pattern for the tilt */
  tiltEasing: import_prop_types.default.string,
  /** The "bump" animation when reaching the last item */
  enableTilt: import_prop_types.default.bool,
  /** Number of visible items  */
  itemsToShow: import_prop_types.default.number,
  /** Number of items to scroll */
  itemsToScroll: import_prop_types.default.number,
  /** Collection of objects with a width, itemsToShow and itemsToScroll  */
  breakPoints: import_prop_types.default.arrayOf(import_prop_types.default.shape({
  ...
  outerSpacing: import_prop_types.default.number,
  // swipe
  ...
  enableAutoPlay: import_prop_types.default.bool,
  /** Set auto play speed (ms) */
  autoPlaySpeed: import_prop_types.default.number,
  // callbacks
...
react/cjs/react-jsx-runtime.development.js:
   ...
   *)
*/
//# sourceMappingURL=@itseasy21_react-elastic-carousel.js.map
