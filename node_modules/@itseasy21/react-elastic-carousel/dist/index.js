...
var Track = function Track(_ref) {
  ...
  var swipeHandler = reactSwipeable.useSwipeable({
  ...
  var toRender = enableSwipe ? /*#__PURE__*/React__default.createElement("div", _extends({
    style: {
      display: "flex",
      flexDirection: verticalMode ? "column" : "row"
    },
    className: cssPrefix("swipable")
  }, swipeHandler), originalChildren) : originalChildren;
  return toRender;
};
